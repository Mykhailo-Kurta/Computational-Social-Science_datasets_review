...
BASE_DIR = Path(r"D:\Desktop\Computational Social Science\Hometask2")

SPENDING_USD_FILE = BASE_DIR / "data.xlsx"
SPENDING_GDP_FILE = BASE_DIR / "data (1).xlsx"
CANCER_FILE = BASE_DIR / "data (2).xlsx"
DTP3_FILE = BASE_DIR / "data (3).xlsx"

OUTPUT_FILE = BASE_DIR / "data" / "who_health_2019.csv"
